...
<head>
    ...
    <title>Vista Áreas Comunes</title>
                ...
                <div class="div2"> 
                    <?php
                        ...
                        while($fila = $resultado->fetch_object()){
                            ...
                            $nomac = $fila->NOMBRE;
                            $objac =$fila -> OBJETIVO;
                            $descac = $fila-> DESCRIPCION;
                            echo "
                            <form action='../php/ecInmueble.php' method = 'POST'>
                                <tr>
                                    <td style='width: 15%' >
                                        <input  id='floatingPassword' class='form-control-plaintext' name='id' value='$idac'>
                                    </td>
                                    <td style='width: 20%' class='align-middle'>
                                        <input  id='floatingPassword' name='nom' class='form-control' style='font-size: 1.4rem; width: 100%' value='$nomac'>
                                    </td>
                                    <td style='width: 20%' >
                                        <input  id='floatingPassword' name='obj' class='form-control-plaintext' value='$objac'>
                                    </td>
                                    <td style='width: 50%' class='align-middle'>
                                        <textarea  id='floatingPassword' class='form-control' style='font-size: 1.4rem;' name='desac'  value='$descac'>$descac</textarea>
                                    </td>
                                    <td>
