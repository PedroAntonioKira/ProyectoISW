    ...
    <div class="fondo-azul p-5">
        <div class="contenedor fondo-blanco m-auto">
            ...
            <div class="parent px-5 ">
                <div class="div2"> 
                    <?php
                        $consulta = "select DATE_FORMAT(FECHA, '%d/%m/%y') AS FECHA, I.NOMBRE as NOMBRE, AP_PATERNO, AP_MATERNO, A.NOMBRE as NOMBRE_AREA from reservar R, inquilino I, area_comun A where R.NUMCONTRATO = I.NUMCONTRATO AND R.ID = A.ID;";
                            ...
                            <form action='' method = 'POST'>
                                <tr>
                                    ...
                                    <td class='align-middle'>
                                        <input  id='floatingPassword' name='curp' class='form-control-plaintext' value='$area'>
                                    </td>
